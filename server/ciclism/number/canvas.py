...
class Canvas():
    ...
    def __init__(self, path_pic, nb_color, plot=False, save=True, pixel_size=2048):
    ...
    def generate(self):
        ...
        for ind, color in enumerate(colors):
            ...
            for contour in cnts:
                ...
                if width_ctr > 1 and height_ctr > 1 and cv2.contourArea(contour, True) < -5:
        ...
        if self.save:
            ...
            cv2.imwrite(f"./outputs/{self.namefile}-canvas-notnumber.png", canvas)
        return canvas    
    ...
    def cleaning(self, picture):
        ...
        clean_pic = cv2.fastNlMeansDenoisingColored(picture,None,0,0,15,10)
